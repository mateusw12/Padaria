    ...
    L10n.load({
      'pt-BR': {
        grid: {
          ...
          Items: 'itens',
          EditOperationAlert:
            'Nenhum registro selecionado para operação de edição',
          ...
          Sort: 'Ordenar',
          FilterDescription:
            'Pressione Alt para baixo para abrir o menu de filtro',
        ...
        spreadsheet: {
          ...
          NoElements:
            'Não foi possível encontrar o que você estava procurando. Clique nas opções para obter mais maneiras de pesquisar',
          ...
          ExtendValidation:
            'A seleção contém algumas células sem validação de dados. Você deseja estender a validação a essas células?',
          Yes: 'sim',
          No: 'Não',
          InvalidFileName: 'O nome do arquivo contém um caractere inválido.',
          PROPER:
            'Converte um texto para maiúsculas e minúsculas; a primeira letra em maiúscula e as outras letras em minúsculas.',
          Cut: 'Recortar',
          Copy: 'Copiar',
          Paste: 'Colar',
          ...
          MergeCellsAlert:
            'A mesclagem de células preservará apenas o valor superior esquerdo (Superior). Mesclar mesmo assim?',
          ...
          PasteAlert:
            'Você não pode colar isso aqui, porque a área de cópia e a área de colar não têm o mesmo tamanho. Tente colar em um intervalo diferente.',
          DestroyAlert:
          ...
          SheetRenameInvalidAlert:
            'O nome da folha contém caracteres inválidos.',
          SheetRenameEmptyAlert: 'O nome da folha não pode estar vazio.',
          SheetRenameAlreadyExistsAlert:
            'O nome da planilha já existe. Por favor, insira outro nome.',
          ...
          DataLimitExceeded:
            'Os dados do arquivo são muito grandes e demoram mais para serem processados. Deseja continuar?',
          ...
          RANDBETWEEN:
            'Retorna um número inteiro aleatório com base nos valores especificados.',
          FLOOR:
            'Arredonda um número para baixo até o múltiplo mais próximo de um determinado fator.',
          CEILING:
            'Arredonda um número até o múltiplo mais próximo de um determinado fator.',
          PRODUCT: 'Multiplica uma série de números e / ou células.',
          AVERAGE:
            'Calcula a média para a série de números e / ou células, excluindo texto.',
          AVERAGEIF:
            'Calcula a média para as células com base no critério especificado.',
          AVERAGEIFS:
            'Calcula a média para as células com base nas condições especificadas.',
          AVERAGEA:
            'Calcula a média das células que avaliam TRUE como 1, texto e FALSE como 0.',
          COUNT:
            'Conta as células que contêm valores numéricos em um intervalo.',
          ...
          CalculateOR:
            'Retorna VERDADEIRO se algum dos argumentos for VERDADEIRO; caso contrário, retornará FALSO.',
          IFERROR:
            'Retorna valor se nenhum erro for encontrado, ele retornará o valor especificado.',
          CHOOSE:
            'Retorna um valor da lista de valores, com base no número do índice.',
          INDEX:
          ...
          SUBTOTAL:
            'Retorna o subtotal para um intervalo usando o número da função fornecido.',
          RADIANS: 'Converte graus em radianos.',
          MATCH:
            'Retorna a posição relativa de um valor especificado em um determinado intervalo.',
          SLOPE:
            'Retorna a inclinação da linha a partir da regressão linear dos pontos de dados.',
          INTERCEPT:
            'Calcula o ponto da linha de interceptação em Y por regressão linear.',
          ...
          EXACT:
            'Verifica se duas strings de texto são exatamente iguais e retorna VERDADEIRO ou FALSO.',
          ...
          COUNTBLANK:
            'Retorna o número de células vazias em um intervalo de células especificado.',
          ...
          MINUTE:
            'Retorna o número de minutos em uma string de tempo especificada.',
          SECOND:
            'Retorna o número de segundos em uma string de tempo especificada.',
          MONTH:
            'Retorna o número de meses em uma string de data especificada.',
          ShowRowsWhere: 'Mostrar linhas onde:',
          OR: 'OU',
          AND: 'E',
          CustomFilterDatePlaceHolder: 'Escolha uma data',
          ...
          EditAlert:
            'A célula que você está tentando alterar está protegida. Para fazer alterações, desproteja a folha.',
          ClearValidation: 'Limpar validação',
          ISNUMBER:
            'Retorna true quando o valor analisa como um valor numérico.',
          ROUND: 'Arredonda um número para um número especificado de dígitos.',
          GEOMEAN:
            'Retorna a média geométrica de uma matriz ou intervalo de dados positivos.',
          ...
          TRUNC:
            'Retorna o valor truncado de um número para um número especificado de casas decimais.',
          ...
          FormatCellsThatContainTheText:
            'Formate as células que contêm o texto:',
          FormatCellsThatContainADateOccurring:
            'Formate as células que contêm uma data que ocorre:',
          ...
          LightRedFillWithDarkRedText:
            'Preenchimento Vermelho Limpar com Texto Vermelho Escuro',
          YellowFillWithDarkYellowText:
            'Preenchimento amarelo com texto amarelo escuro',
          GreenFillWithDarkGreenText:
            'Preenchimento Verde com Texto Verde Escuro',
          ...
          SUMPRODUCT:
            'Retorna a soma do produto de determinados intervalos de matrizes.',
          TODAY: 'Retorna a data atual como valor de data.',
          ROUNDUP: 'Arredonda um número longe de zero.',
          Replace: 'Substituir...',
          Find: 'Encontrar e substituir ...',
          Goto: 'Vamos para...',
          GotoSpecial: 'Vá para especial...',
          Link: 'Ligação',
          SpreadsheetHyperlink: 'Hiperlink de planilha',
          Hyperlink: 'Hiperlink',
          ...
          ClearAll: 'Limpar tudo',
          ClearFormats: 'Limpar formatação',
          ...
          LightblueDataBar: 'Barra de dados azul Limpar',
          ...
          InCorrectPassword:
            'Não é possível abrir o arquivo ou planilha com a senha fornecida',
        ...
        filemanager: {
          ...
          'Content-Multiple-Delete':
            'Tem certeza de que deseja excluir esses {0} arquivos?',
          ...
          Error: 'Erro',
          'Validation-Empty':
            'O nome do arquivo ou pasta não pode estar vazio.',
          'Validation-Invalid':
          ...
          'Validation-NewFolder-Exists':
            'Um arquivo ou pasta com o nome {0} já existe.',
          'Validation-Rename-Exists':
            'Não é possível renomear {0} para {1}: o destino já existe.',
          ...
          'Sub-Folder-Error':
            'A pasta de destino é a subpasta da pasta de origem.',
        ...
        schedule: {
          ...
          alert: 'Alerta',
          startEndError:
            'A data final selecionada ocorre antes da data de início.',
        ...
        gantt: {
          ...
          confirmPredecessorDelete:
            'Tem certeza de que deseja remover o link de dependência?',
          unit: 'Unidade',
          work: 'Trabalhos',
        ...
        richtexteditor: {
          ...
          imageUploadMessage:
            'Solte a imagem aqui ou navegue para fazer upload',
          ...
          tableCellHorizontalAlign:
            'Alinhamento horizontal da célula da tabela',
        ...
        pivotview: {
          ...
          fieldExist:
            'Um campo já existe com este nome. Digite um nome diferente.',
          confirmText:
            'Um campo de cálculo já existe neste nome. Quer substituir?',
          ...
          drillError:
            'Não é possível mostrar os itens brutos dos campos calculados.',
          ...
          removeCalculatedField:
            'Tem certeza de que deseja excluir este campo calculado?',
        ...
        pivotfieldlist: {
          ...
          formula: 'Fórmula',
          fieldExist:
            'Um campo já existe neste nome. Digite um nome diferente.',
          confirmText:
            'Um campo de cálculo já existe neste nome. Quer substituir?',
          noMatches: 'Sem combinações',
          ...
          removeCalculatedField:
            'Tem certeza de que deseja excluir este campo calculado?',
          yes: 'Tem certeza de que deseja excluir este campo calculado?',
          no: 'Sim',
          None: 'Não',
        },
        pdfviewer: {
          ...
          Download: 'Baixar',
          'Enter Password':
            'Este documento é protegido por senha. Por favor insira uma senha.',
        ...
        DocumentEditor: {
          ...
          'Allow row to break across pages':
            'Permitir quebra de linha nas páginas',
          ...
          Dot: 'Solteiro',
          DashSmallGap: 'Ponto',
          DashLargeGap: 'DashSmallGap',
          DashDot: 'DashLargeGap',
          DashDotDot: 'DashDot',
          Double: 'DashDotDot',
          Triple: 'Dobro',
          ThinThickSmallGap: 'Triplo',
          ThickThinSmallGap: 'ThinThickSmallGap',
          ThinThickThinSmallGap: 'ThickThinSmallGap',
          ThinThickMediumGap: 'ThinThickThinSmallGap',
          ThickThinMediumGap: 'ThinThickMediumGap',
          ThinThickThinMediumGap: 'ThickThinMediumGap',
          ThinThickLargeGap: 'ThinThickThinMediumGap',
          ThickThinLargeGap: 'ThinThickLargeGap',
          ThinThickThinLargeGap: 'ThickThinLargeGap',
          SingleWavy: 'ThinThickThinLargeGap',
          DoubleWavy: 'ÚnicoOndulado',
          DashDotStroked: 'DoubleWavy',
          Emboss3D: 'TraçoDotStroked',
          Engrave3D: 'Emboss3D',
          Outset: 'Gravar 3D',
          Inset: 'Início',
          Thick: 'Inserir',
          ...
          'Different odd and even': 'Diferentes ímpares e pares',
        ...
        'rich-text-editor': {
          alignments: 'alinhamentos',
          justifyleft: 'justificar a esquerda',
          justifycenter: 'justificar ao centro',
          justifyright: 'justificar a direita',
          justifyfull: 'justificar completamente',
          fontname: 'nome da fonte',
          fontsize: 'tamanho da fonte',
          fontcolor: 'cor da fonte',
          backgroundcolor: 'cor de fundo',
          ...
          editlink: 'editar link',
          removelink: 'remover link',
          openimagelink: 'abrir link da imagem',
          editimagelink: 'editar link da imagem',
          removeimagelink: 'remover link da imagem',
          image: 'imagem',
          replace: 'substituir',
          align: 'alinhar',
          caption: 'rubrica',
          ...
          tableCellBackground: 'Fundo da Célula da Tabela',
          tableEditProperties: 'Propriedades de edição da tabela',
          styles: 'Estilos',
          insertColumnLeft: 'Inserir coluna à esquerda',
          insertColumnRight: 'Inserir coluna à direita',
          deleteColumn: 'Excluir coluna',
        ...
        PdfViewer: {
          ...
          'Color edit': 'Mudar cor',
          'Opacity edit': 'Alterar Transparência',
          'Highlight context': 'Realçar',
          'Underline context': 'Sublinhado',
          'Strikethrough context': 'Strike through',
          'Server error':
            'O serviço da Web não está escutando. O Visualizador de PDF depende do serviço da Web para todos os seus recursos. Por favor, inicie o serviço web para continuar.',
          'Open text': 'Aberto',
          'First text': 'Primeira página',
          'Previous text': 'Página anterior',
          'Next text': 'Próxima página',
          ...
          'Import Failed':
            'Tipo de arquivo JSON ou nome de arquivo inválido; selecione um arquivo JSON válido',
          'Import PDF Failed':
            'Tipo de arquivo PDF inválido ou arquivo PDF não existe. Selecione um arquivo PDF válido',
          'File not found':
            'O arquivo JSON importado não foi encontrado no local desejado',
          'Export Failed':
            'A ação de exportação de anotações falhou; certifique-se de que as anotações sejam adicionadas corretamente',
          of: 'de',
          Dynamic: 'Dinâmico',
        ...
        documenteditor: {
          ...
          'Contextual Spacing':
            'Não adicione espaço entre os parágrafos dos mesmos estilos',
          ...
          'Highlight the regions I can edit':
            'Destaque as regiões que posso editar',
          'Show All Regions I Can Edit':
            'Mostrar todas as regiões que posso editar',
          'Find Next Region I Can Edit':
            'Encontre a próxima região que posso editar',
          'Keep source formatting': 'Mantenha a formatação de origem',
          'Match destination formatting':
            'Corresponder à formatação do destino',
          ...
          'Add Headings':
            'Este documento não possui cabeçalhos. Adicione títulos e tente novamente.',
          ...
          'Merge Track':
            'Esta ação não será marcada como alteração. Você quer continuar?',
          ...
          Unlock: 'Desbloquear',
          'Already locked':
            'Selecionada ou parte da região já está bloqueada por outro usuário',
          '1, 2, 3, ...': '1, 2, 3, ...',
          'a, b, c, ...': 'a, b, c, ...',
          'A, B, C, ...': 'A, B, C, ...',
          'I, II, III, ...': 'I, II, III, ...',
          ...
          'Click to View/Edit Footnote':
            'Clique para ver / editar nota de rodapé',
          ...
          'Number of rows must be between 1 and 32767.':
            'O número de linhas deve estar entre 1 e 32767.',
          'Number of columns must be between 1 and 63.':
            'O número de colunas deve estar entre 1 e 63.',
          Unlimited: 'Ilimitado',
          ...
          TrackChangesOnly:
            'Você pode editar nesta região, mas todas as alterações serão rastreadas',
          ...
          'You may format text only with certain styles':
            'Você pode formatar o texto apenas com certos estilos.',
          'Ignore all': 'Ignore tudo',
        },
        documenteditorcontainer: {
          ...
          'Show page numbers in table of contents':
            'Mostrar números de página no índice.',
          'Right align page numbers':
            'Alinhar à direita os números das páginas',
          ...
          'Insert inline picture from a file':
            'Inserir imagem embutida de um arquivo.',
          ...
          'Open the page setup dialog':
            'Abra a caixa de diálogo de configuração da página.',
          ...
          'Update cross reference fields':
            'Atualizar campos de referência cruzada',
          ...
          'Heading 6': 'Título 6',
          ZoomLevelTooltip:
            'Nível de zoom. Clique ou toque para abrir as opções de Zoom.',
          None: 'Nenhum',
          Borders: 'Fronteiras',
